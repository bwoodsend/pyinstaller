...
from PyInstaller.depend.bytecode import function_calls, search_recursively
...
def test_local_functions():
    """Test function_calls() on nested code objects."""

    # This creates 3 code objects:
    #   - A global code.
    #   = The contents of foo().
    ...
    assert search_recursively(function_calls, code) == {
        code: [],
